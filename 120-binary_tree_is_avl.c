 ...
 * @lo: ivelu ye smallest node evakashile thus far.
 * @hi: ivelu ye largest node evakashile this far.
 *
...
/**
 * binary_tree_is_avl - ishekha ukuthi i-binary tree is a valid AVL tree.
 * @tree: A pointer kwi root node ye tree yokushekha.
 *
