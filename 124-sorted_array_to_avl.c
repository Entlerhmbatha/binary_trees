...
/**
 * aux_sort - ikhanda the tree using the half element of the array
 * @parent: umzali we node to create
 * @array: sorted array
...
/**
 * sorted_array_to_avl - ikhanda i-alv tree from sorted array
 * @array: sorted array
 * @size: usayizi we sorted array
