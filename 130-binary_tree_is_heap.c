...
/**
 * binary_tree_height - ifanshini ekala ubude be-binary tree
...
/**
 * binary_tree_balance - ikala balance factor of a binary tree
 * @tree: tree to go through
...
/**
 * tree_is_perfect - ifankshini ehi if a tree is perfect or not
...
/**
 * binary_tree_is_perfect - msulwa noma cha a tree
 * @tree: tree to check
...
/**
 * binary_tree_is_heap - ihlola ukuthi binary tree is a valid Max Binary Heap
 * @tree: tree to check
 * Return: 1 is it is or 0 if not
 */
